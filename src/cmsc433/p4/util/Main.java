...
import cmsc433.p4.actors.SimulationManagerActor;
...
//		}
	...
	private static ArrayList<NodeSpecification> setupTest1 () throws FileNotFoundException {
		...
		// Create user scripts
		UserScript script1 = UserScript.fromFile("test1script1new.txt");
		UserScript script2 = UserScript.fromFile("test1script2new.txt");
